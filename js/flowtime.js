...
var Flowtime = (function ()
{
  ...
  var _isScrollActive = false;//true;                                                            // flags to enable or disable javascript input listeners for the navigation
  var _isScrollable = false;//true;                                                             
...
*/
  ...
  function _updateNavigation(fireEvent) {
    ...
    //console.log("NavigationMatrix.update()")
    NavigationMatrix.update();  
    //
